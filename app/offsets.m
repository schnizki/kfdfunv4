...
//        
//    } else if (SYSTEM_VERSION_EQUAL_TO(@"16.6")||SYSTEM_VERSION_EQUAL_TO(@"16.4")||SYSTEM_VERSION_EQUAL_TO(@"16.4.1")||SYSTEM_VERSION_EQUAL_TO(@"16.5")) {
//        NSLog(@"[i] offsets selected for iOS 16.6");
//        off_p_list_le_prev = 0x8;
//        off_p_proc_ro = 0x18;
//        off_p_ppid = 0x20;
//        off_p_original_ppid = 0x24;
